...
namespace HoroscopeApplication.Repository
{
    public static class SunsignBasicInfoRepository
    {
        ...
        public static void MapSunsignBasicInfo()
        {
            ...
            {
                _sunsignInfo.Add(sunsigns[0], new SunsignBasicInfo { DateRange = "March 21 – April 20", About = "Aries is the first sign of the Zodiac. It is associated with fresh vigor and new beginnings." });
                _sunsignInfo.Add(sunsigns[1], new SunsignBasicInfo { DateRange = "April 21 – May 20", About = "Taurus is the second sign of the Zodiac and is associated with material pleasure." });
                _sunsignInfo.Add(sunsigns[2], new SunsignBasicInfo { DateRange = "May 21 – June 21", About = "Gemini is the third sign of the Zodiac and is associated with youth and versatility." });
                ...
                _sunsignInfo.Add(sunsigns[7], new SunsignBasicInfo { DateRange = "October 23 – November 22", About = "Scorpio is the eighth sign of the Zodiac. It is associated with intensity, passion, and power." });
                _sunsignInfo.Add(sunsigns[8], new SunsignBasicInfo { DateRange = "November 23 – December 21", About = "Sagittarius is the ninth sign of the Zodiac. It is associated with travel and expansion." });
